...
// schematics-go-sdk/0.0.1 (lang=go; arch=x86_64; os=Linux; go.version=1.12.9)
//
// In the example above, the analytics tool will parse the user-agent header and
// use the following properties:
// "schematics-go-sdk" - the name of your sdk
...
func GetComponentInfo() *core.ProblemComponent {
	...
	return core.NewProblemComponent("https://github.com/IBM/schematics-go-sdk", Version)
}
